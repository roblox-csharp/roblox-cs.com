...
&ThickSpace;<span class="cs-kw">if</span> <span class="cs-b2">(</span><span class="cs-id">instance</span> <span class="cs-kw">is</span> <span class="cs-class">BasePart</span> <span class="cs-id">part</span><span class="cs-b2">)</span>
&ThickSpace;<span class="cs-b2">{</span>
&ThickSpace;&ThickSpace;<span class="cs-id">part</span><span class="cs-op">.</span><span class="cs-id">Touched</span><span class="cs-op">.</span><span class="cs-fn">Connect</span><span class="cs-b3">(</span><span class="cs-id">hit</span> <span class="cs-op">=></span>
&ThickSpace;&ThickSpace;&ThickSpace;<span class="cs-id">hit</span><span class="cs-op">.</span><span class="cs-id">Parent</span><span class="cs-op">?</span>
&ThickSpace;&ThickSpace;&ThickSpace;&ThickSpace;<span class="cs-op">.</span><span class="cs-fn">FindFirstChildOfClass</span><span class="cs-op">&lt;</span><span class="cs-class">Humanoid</span><span class="cs-op">&gt;()?</span>
